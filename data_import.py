...
class ImportTools:
    ...
    def create_statement():
        ...
        create_string = "CREATE TABLE cr ( \n"
        create_string += "anid int NOT NULL AUTO_INCREMENT, \n"
        # Add in variables that we will add in:
    ...
    def create_table():
        # TODO
        drop_existing = "DROP TABLE IF EXISTS cr;"
        create_statement = ImportTools.create_statement()
        if not In_pycharm:
...
class ImportStudy:
    ...
    def phase1study(self, file_name="Phase 1 Sediment.csv"):
        # TODO: add columns for study name & coordinate system
        temp_table = ImportTools.read_in_csv(filename=file_name)
